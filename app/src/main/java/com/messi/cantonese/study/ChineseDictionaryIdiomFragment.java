...
import com.messi.cantonese.study.dao.ChDicIdiomDao;
...
public class ChineseDictionaryIdiomFragment extends Fragment implements OnClickListener {
    ...
    public static ChineseDictionaryIdiomFragment getInstance() {
        ChineseDictionaryIdiomFragment mMainFragment = new ChineseDictionaryIdiomFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_ch_dictionary_idiom, null);
        init();
        return view;
    }
    ...
    private void submit() {
        ...
        if (!TextUtils.isEmpty(word)) {
            ...
            ToastUtil.diaplayMesShort(getActivity(), getActivity().getResources().getString(R.string.ch_dic_idiom_input_hint));
            finishLoadding();
        }
    }
