...
public class RcWechatJXListItemViewHolder extends RecyclerView.ViewHolder {
    ...
    public RcWechatJXListItemViewHolder(View convertView) {
        super(convertView);
    ...
    private void toDetailActivity(WechatJXResult mAVObject){
