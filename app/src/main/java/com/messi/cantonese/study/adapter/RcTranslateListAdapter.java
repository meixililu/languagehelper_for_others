...
public class RcTranslateListAdapter extends HeaderRecyclerViewAdapter<RecyclerView.ViewHolder, Object, record, Object> {
	...
	private RcTranslateLiatItemViewHolder mItemViewHolder;

	public RcTranslateListAdapter(SpeechSynthesizer mSpeechSynthesizer, SharedPreferences mSharedPreferences,
								  List<record> beans){
		this.beans = beans;
	...
	protected RecyclerView.ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
		...
		return new RcTranslateLiatItemViewHolder(characterView,beans,mSpeechSynthesizer,mSharedPreferences,this);
	}

	@Override
	protected void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
		record mAVObject = getItem(position);
		mItemViewHolder = (RcTranslateLiatItemViewHolder)holder;
